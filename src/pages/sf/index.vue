    ...
    methods: {
      ...
      search(type){
        if(this.form.date_type == '1'){
          this.form.date_range = this.formatDate(new Date().DateAddORSub("d","-",7))
        } else if(this.form.date_type == '2'){
          this.form.date_range = this.formatDate(new Date().DateAddORSub("d","-",30))
        }else if(this.form.date_type == '3'){
          this.form.date_range = this.formatDate(new Date().DateAddORSub("d","-",180))
        } else {
